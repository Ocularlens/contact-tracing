    ...
    <div class="row justify-content-center">
        <div class="col-md-12 card">    
            <div class="card-body">
                ...
                @endif
                <form action="/dashboard/store/{{$store->store_id}}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <textarea name="description" id="description" placeholder="Description" rows="10" class="form-control">{{$store->description}}</textarea><br>
